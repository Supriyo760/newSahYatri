      ...
      <main className="relative z-10 w-full max-w-[480px]">
        ...
        <div className="w-full bg-white/80 backdrop-blur-sm p-10 journal-shadow border border-[#ddc0b9]/30 rounded-2xl">
          <header className="mb-8 text-center">
            <h1 className="font-journal-headline text-4xl text-[#8f361d] mb-2">Welcome back, Wanderer</h1>
            <p className="font-journal-body text-xs text-[#56423d] italic">The road you left is waiting for your return.</p>
          </header>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-transparent border-t-0 border-x-0 border-b border-[#ddc0b9] focus:ring-0 focus:border-[#8f361d] px-0 py-2 font-journal-body text-sm placeholder:text-[#ddc0b9]/60 transition-colors focus:outline-none"
                required
              />
            </div>

            <div className="relative group">
              <label className="font-journal-label text-[10px] text-[#89726c] block mb-1">Passcode</label>
              <input
                type="password"
                value={password}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#8f361d] text-white font-journal-label text-xs py-4 tracking-widest hover:bg-[#af4d32] active:scale-[0.98] transition-all journal-shadow rounded-xl"
            >
              {loading ? 'RESUMING JOURNEY...' : 'RESUME JOURNEY'}
            </button>
          </form>
          ...
          <div className="mt-8">
            ...
            <div className="flex justify-center">
              <button
                ...
                className="flex w-full items-center justify-center gap-2 border border-[#ddc0b9]/40 py-3 rounded-lg font-journal-body text-xs hover:bg-[#f0eee9] transition-colors cursor-pointer"
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24">
                  ...
                  <path
                    fill="#34A853"
                    d="M12 23c3.24 0 5.97-1.07 7.96-2.92l-3.73-2.89a6.98 6.98 0 0 1-10.45-3.8l-3.9 3.02C3.86 20.26 7.6 23 12 23z"
                  />
                </svg>
                <span>Google</span>
              </button>
          ...
          <footer className="mt-8 pt-6 border-t border-[#ddc0b9]/20 text-center">
            <Link href="/auth/register" className="font-journal-body text-xs text-[#8f361d] hover:underline cursor-pointer">
              First expedition? <span className="font-bold underline">Begin your story</span>
            </Link>
          </footer>
        </div>
